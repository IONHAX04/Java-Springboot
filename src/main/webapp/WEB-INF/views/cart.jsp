...
<head>
    ...
    <style>
        ...
        body {
            ...
            margin: 0;
            padding: 0;
			background: url('../css/img/header/top-8.jpg')no-repeat center center;
        }
...
<body>
    <section>
         <div class="mt-16 image-container relative">
            <img src="../css/img/header/top-8.jpg" alt="Summer Collection" class="w-full h-44 md:h-48 object-cover">
